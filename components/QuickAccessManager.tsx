...
const QuickAccessManager: React.FC<QuickAccessManagerProps> = (props) => {
    const { 
    ...
    return (
        <section>
            <h2 className="text-2xl font-semibold text-mono-text-primary mb-6">Quick Access</h2>
            ...
            <div className="rounded-xl p-2 glossy-card">
                ...
                <table className="w-full text-sm text-left">
                    ...
                    {isLoading ? (
                        ...
                        <tr><td colSpan={6} className="text-center p-8 text-mono-text-secondary">No items in Quick Access. Add files for easy access.</td></tr>
                    ) : (
                        files.map((file) => {
